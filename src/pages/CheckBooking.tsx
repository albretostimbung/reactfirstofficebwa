...
import apiClient, { baseURLStorage, isAxiosError } from "../services/apiService";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="flex flex-col w-full gap-2">
            ...
            {formErrors.find((error) => error.path.includes("booking_trx_id")) && (
              <p className="text-[#FF2D2D]">Booking TRX ID is required</p>
            )}
          </div>
          <div className="flex flex-col w-full gap-2">
        ...
        {
          error && (
            <p className="text-[#FF2D2D] text-center">Booking data not found</p>
          )
        }
            ...
            <div className="flex flex-col h-fit shrink-0 rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
              <div className="flex items-center gap-4">
                <div className="flex shrink-0 w-[140px] h-[100px] rounded-[20px] overflow-hidden">
                  <img
                    src={`${baseURLStorage}/${bookingDetails.officeSpace.thumbnail}`}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-[6px]">
                    <img
                      ...
                      alt="icon"
                    />
                    <p className="font-semibold">{bookingDetails.officeSpace?.city?.name}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center rounded-full px-5 py-3 gap-[10px] bg-[#F7F7FD]">
                    <img
                      ...
                      alt="icon"
                    />
                    <p className="font-semibold">{bookingDetails.started_date}</p>
                  </div>
                </div>
                <div className="flex flex-col gap-2">
                  <h3 className="font-semibold">
                  ...
                  <div className="flex items-center rounded-full px-5 py-3 gap-[10px] bg-[#F7F7FD]">
                    <img
                      ...
                      alt="icon"
                    />
                    <p className="font-semibold">{bookingDetails.ended_date}</p>
                  </div>
                </div>
              </div>
              <hr className="border-[#F6F5FD]" />
